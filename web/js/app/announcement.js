...
function openSupportPage() {
    window.open('https://ifdian.net/a/XinkuoaStudio?tab=home', '_blank');
    dismissSupportModal();
}
...
var ANNOUNCEMENT_CONTENT = {
    ...
    body: `
        ...
        <div class="announcement-section">
            ...
            <p>如果你对 Bbot 功能感兴趣，欢迎前往 <a href="javascript:void(0)" onclick="window.electronAPI?.openExternal('https://ifdian.net/a/XinkuoaStudio')" style="color:var(--accent-color);font-weight:bold;">爱发电</a> 支持我们的发展</p>
        </div>
