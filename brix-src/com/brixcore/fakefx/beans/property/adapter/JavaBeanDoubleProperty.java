...
public final class JavaBeanDoubleProperty extends DoubleProperty implements JavaBeanProperty<Number> {
    ...
    public double get() {
        return ((Double) AccessController.doPrivileged(new PrivilegedAction() { // from class: com.brixcore.fakefx.beans.property.adapter.JavaBeanDoubleProperty$$ExternalSyntheticLambda1
    ...
    public void set(final double value) {
        ...
        AccessController.doPrivileged(new PrivilegedAction() { // from class: com.brixcore.fakefx.beans.property.adapter.JavaBeanDoubleProperty$$ExternalSyntheticLambda0
            @Override // java.security.PrivilegedAction
            public final Object run() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ Void lambda$set$1(double value) {
        try {
            MethodHelper.invoke(this.descriptor.getSetter(), getBean(), new Object[]{Double.valueOf(value)});
