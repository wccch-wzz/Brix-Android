...
import com.brixcore.fakefx.beans.property.ReadOnlyStringPropertyBase;
...
public final class ReadOnlyJavaBeanStringProperty extends ReadOnlyStringPropertyBase implements ReadOnlyJavaBeanProperty<String> {
    ...
    public String get() {
        return (String) AccessController.doPrivileged(new PrivilegedAction() { // from class: com.brixcore.fakefx.beans.property.adapter.ReadOnlyJavaBeanStringProperty$$ExternalSyntheticLambda0
    ...
    @Override // com.brixcore.fakefx.beans.property.ReadOnlyStringPropertyBase, com.brixcore.fakefx.beans.property.adapter.ReadOnlyJavaBeanProperty
