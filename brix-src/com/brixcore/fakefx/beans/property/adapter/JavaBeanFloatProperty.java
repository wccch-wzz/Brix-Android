...
public final class JavaBeanFloatProperty extends FloatProperty implements JavaBeanProperty<Number> {
    ...
    public float get() {
        return ((Float) AccessController.doPrivileged(new PrivilegedAction() { // from class: com.brixcore.fakefx.beans.property.adapter.JavaBeanFloatProperty$$ExternalSyntheticLambda1
    ...
    public /* synthetic */ Float lambda$get$0() {
        try {
            return Float.valueOf(((Number) MethodHelper.invoke(this.descriptor.getGetter(), getBean(), null)).floatValue());
    ...
    public void set(final float value) {
        ...
        AccessController.doPrivileged(new PrivilegedAction() { // from class: com.brixcore.fakefx.beans.property.adapter.JavaBeanFloatProperty$$ExternalSyntheticLambda0
            @Override // java.security.PrivilegedAction
            public final Object run() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ Void lambda$set$1(float value) {
        try {
            MethodHelper.invoke(this.descriptor.getSetter(), getBean(), new Object[]{Float.valueOf(value)});
