...
import com.brixcore.fakefx.beans.property.ReadOnlyObjectPropertyBase;
...
public final class ReadOnlyJavaBeanObjectProperty<T> extends ReadOnlyObjectPropertyBase<T> implements ReadOnlyJavaBeanProperty<T> {
    ...
    public T get() {
        return (T) AccessController.doPrivileged(new PrivilegedAction() { // from class: com.brixcore.fakefx.beans.property.adapter.ReadOnlyJavaBeanObjectProperty$$ExternalSyntheticLambda0
    ...
    @Override // com.brixcore.fakefx.beans.property.ReadOnlyObjectPropertyBase, com.brixcore.fakefx.beans.property.adapter.ReadOnlyJavaBeanProperty
