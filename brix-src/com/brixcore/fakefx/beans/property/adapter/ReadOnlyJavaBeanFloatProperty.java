...
import com.brixcore.fakefx.beans.property.ReadOnlyFloatPropertyBase;
...
public final class ReadOnlyJavaBeanFloatProperty extends ReadOnlyFloatPropertyBase implements ReadOnlyJavaBeanProperty<Number> {
    ...
    public float get() {
        return ((Float) AccessController.doPrivileged(new PrivilegedAction() { // from class: com.brixcore.fakefx.beans.property.adapter.ReadOnlyJavaBeanFloatProperty$$ExternalSyntheticLambda0
    ...
    @Override // com.brixcore.fakefx.beans.property.ReadOnlyFloatPropertyBase, com.brixcore.fakefx.beans.property.adapter.ReadOnlyJavaBeanProperty
