...
public final class JavaBeanLongProperty extends LongProperty implements JavaBeanProperty<Number> {
    ...
    public long get() {
        return ((Long) AccessController.doPrivileged(new PrivilegedAction() { // from class: com.brixcore.fakefx.beans.property.adapter.JavaBeanLongProperty$$ExternalSyntheticLambda1
    ...
    public void set(final long value) {
        ...
        AccessController.doPrivileged(new PrivilegedAction() { // from class: com.brixcore.fakefx.beans.property.adapter.JavaBeanLongProperty$$ExternalSyntheticLambda0
            @Override // java.security.PrivilegedAction
            public final Object run() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ Void lambda$set$1(long value) {
        try {
            MethodHelper.invoke(this.descriptor.getSetter(), getBean(), new Object[]{Long.valueOf(value)});
