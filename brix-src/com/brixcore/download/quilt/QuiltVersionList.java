...
public final class QuiltVersionList extends VersionList<QuiltRemoteVersion> {
    ...
    public CompletableFuture<?> refreshAsync() {
        return CompletableFuture.runAsync(Lang.wrap((ExceptionalRunnable<?>) new ExceptionalRunnable() { // from class: com.brixcore.download.quilt.QuiltVersionList$$ExternalSyntheticLambda1
        ...
        try {
            for (String str : gameVersions) {
                for (String str2 : gameVersions2) {
                    this.versions.put(str, new QuiltRemoteVersion(str, str2, Collections.singletonList(getLaunchMetaUrl(str, str2))));
                }
            }
    ...
    private List<String> getGameVersions(String metaUrl) throws IOException {
        ...
        return (List) ((ArrayList) JsonUtils.GSON.fromJson(json, new TypeToken<ArrayList<GameVersion>>() { // from class: com.brixcore.download.quilt.QuiltVersionList.1
        }.getType())).stream().map(new Function() { // from class: com.brixcore.download.quilt.QuiltVersionList$$ExternalSyntheticLambda0
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                return ((QuiltVersionList.GameVersion) obj).getVersion();
            }
