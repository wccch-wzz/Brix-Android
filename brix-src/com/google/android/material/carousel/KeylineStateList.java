...
class KeylineStateList {
    ...
    private static List<KeylineState> getStateStepsStart(Carousel carousel, KeylineState defaultState, float itemMargins, float leftOrTopPaddingForKeylineShift) {
        ...
        while (dstIndex < numberOfSteps) {
            ...
            int i2 = dstIndex2;
            KeylineState shifted = moveKeylineAndCreateKeylineState(prevStepState, firstNonAnchorKeylineIndex, i2, originalStart + cutoffs4, newFirstFocalIndex, newLastFocalIndex, carouselSize);
            if (newLastFocalIndex2 == numberOfSteps - 1 && leftOrTopPaddingForKeylineShift > f) {
