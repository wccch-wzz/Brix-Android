...
public final class ViewingConditions {
    ...
    public static ViewingConditions make(double[] whitePoint, double adaptingLuminance, double backgroundLstar, double surround, boolean discountingIlluminant) {
        ...
        double d = MathUtils.clampDouble(0.0d, 1.0d, discountingIlluminant ? 1.0d : (1.0d - (Math.exp(((-adaptingLuminance) - 42.0d) / 92.0d) * 0.2777777777777778d)) * f);
        double[] rgbD = {(((100.0d / rW) * d) + 1.0d) - d, (((100.0d / gW) * d) + 1.0d) - d, (((100.0d / bW) * d) + 1.0d) - d};
